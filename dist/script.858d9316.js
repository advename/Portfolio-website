...
},{"./TweenLite.js":"node_modules\\gsap\\TweenLite.js"}],"node_modules\\hammerjs\\hammer.js":[function(require,module,exports) {
var define;
...
},{}],"node_modules\\validator-js\\src\\validator.js":[function(require,module,exports) {
var define;
...
},{"./bundle-url":"..\\..\\..\\AppData\\Roaming\\npm\\node_modules\\parcel-bundler\\src\\builtins\\bundle-url.js"}],"styles\\sass\\main.scss":[function(require,module,exports) {

var reloadCSS = require('_css_loader');
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"..\\..\\..\\AppData\\Roaming\\npm\\node_modules\\parcel-bundler\\src\\builtins\\css-loader.js"}],"scripts\\script.js":[function(require,module,exports) {
"use strict";
...
var circles = document.querySelectorAll(".circles"); //background circles
var svgToBeInjected = document.querySelectorAll(".inject-svg");
var navBackground = document.querySelectorAll("nav .background");
var navUL = document.querySelector("nav .front ul");
var navLIS = document.querySelectorAll("nav ul li");
var burgerMenu = document.querySelector("#burger-menu");
var burgerMenuSpan = document.querySelectorAll("#burger-menu span");
var loader = document.querySelector("#loader");
var burgerMenuOpen = false;
var circleDefColor = "#e3e3e3";
var vh = void 0,
    vw = void 0,
    centerX = void 0,
    centerY = void 0,
    circleMaxW = void 0,
    circleTL = void 0;
var sectionActive = -1; //on page load, hero section is the first visible one
var allowCircleAnimation = true;
var isMobile = false; //used to define if on mobile devices or not
var mouseX = 0;
var mouseY = 0;
var scrollDir = "down";
var smoothScrollToInUse = false;
var scrollTo = 0;
var sections = ["hero", "intro", "tech", "port", "contact"];

//*** Hero
var heroTitle = document.querySelector("#hero .title");
var heroImg = document.querySelector("#hero .title-image");

//*** Intro
var introWrapper = document.querySelector("#intro .wrapper");
var introHeadlineDOM = document.querySelector("#intro .headline h2");
var introWhiteBar = document.querySelector("#intro .white-bar-headline");
var introHeadline = void 0;
var introActivated = false;

//*** Technology
var techWrapper = document.querySelector("#tech .wrapper");
var techLineDOM = document.querySelector("#tech .animation .line");

var techTemplate = document.querySelector("#tech-template").content;
var techContainer = document.querySelector("#tech .slider .container");
var techBox = document.querySelector("#tech .slider .box");

var techStartX = void 0,
    techDistance = void 0,
    techCirclesTL = void 0,
    techSliderData = void 0,
    techContainerWidth = void 0,
    techEditorLines = void 0,
    techEditorCodeTL = void 0,
    techSliderItem = void 0;
var techEditorLinesWidth = [];
var techSliderActivated = false;

//*** Portfolio
var port = document.querySelector("#port");
var portContainer = document.querySelector("#port .container");
var portWrapper = document.querySelector("#port .wrapper");
var portTemplate = document.querySelector("#port-template").content;
var portPageCountCurrent = document.querySelector("#port .pagecount .current");
var portPageCountOutOf = document.querySelector("#port .pagecount .out-of");
var portScrollbar = document.querySelector("#port .scrollbar");

var portOffSetTop = void 0,
    portWorkMarginRight = void 0,
    portContainerWidth = void 0,
    portMoveDistance = void 0,
    portContainerLeft = void 0,
    portData = void 0,
    portWork = void 0;
var portAllowScroll = true;
var portAllowSlider = false;
var portSliderAnimationActive = false;
var portCurrentPage = 1;

//*** Contact
var contactWhiteSplitter = document.querySelector("#contact .white-splitter");
var contactFooterSpan = document.querySelector("#contact footer span");
...
function beforeInit() {
  svgToBeInjected.forEach(function (svg) {
    SVGInject(svg);
  });
}
...
function init() {
  ...
  if (_is_js2.default.mobile()) setupMobile();
  console.log("Is it mobile/tablet: " + _is_js2.default.mobile());
  ...
  var mc = new _hammerjs2.default(window, { treshold: 1000 }); //HammerJS and enable all directions
  mc.get("pan").set({ direction: _hammerjs2.default.DIRECTION_ALL });
  ...
  // Make GSAP Timeline
  circleTL = new _TweenMax.TimelineMax(); //Circle background pages
  techCirclesTL = new _TweenMax.TimelineMax({ repeat: -1, repeatDelay: 0 }); //Circle tech sections between code editor and device
  ...
  techSliderItem = document.querySelector("#tech .slider .container .item:last-of-type");

  //Activate animation
  techSliderAnimation();

  //Tech Code Editor animation setup
  techEditorLines = document.querySelectorAll("#tech .code-editor svg [id*='editor-lines']");
  techCodeEditorSetup();
...
function scrollHandler(e) {
  ...
  } else if (e.type == "wheel" || !_is_js2.default.mobile()) {
...
function smoothScrollTo(e) {
  if (portAllowScroll) {
    _TweenMax.TweenMax.to(window, 0.7, {
      scrollTo: scrollTo,
...
function setupMobile() {
  ...
  parents[0].style.marginBottom = window.screen.height - window.innerHeight + "px";
}
...
function toggleBurgerMenu() {
  if (burgerMenuOpen) {
    //close burger menu
    navBackground.forEach(function (back) {
      back.classList.remove("nav-animation");
    });
    navLIS.forEach(function (li) {
      li.classList.remove("nav-animation");
    });
    burgerMenuSpan.forEach(function (span) {
...
function sectionsHandler() {
  ...
  if (sectionActive != 4) {
    if (isMobile) circleDefColor = "rgba(227, 227, 227, 0.3);";else if (!isMobile) circleDefColor = "#e3e3e3";
  }
  if (sectionActive === 1) {
...
function repositionCircles(cord) {
  ...
  //New timeline
  circleTL.to(circles[0], duration, {
    left: cord[0].x,
    top: cord[0].y,
    width: cord[0].size,
    height: cord[0].size,
    background: circleDefColor
  }, 0).to(circles[1], duration, {
    left: cord[1].x,
    top: cord[1].y,
    width: cord[1].size,
    height: cord[1].size,
    background: circleDefColor
  }, 0).to(circles[2], duration, {
    left: cord[2].x,
    top: cord[2].y,
    width: cord[2].size,
    height: cord[2].size,
    background: circleDefColor
  }, 0).to(circles[3], duration, {
    left: cord[3].x,
    top: cord[3].y,
    width: cord[3].size,
    height: cord[3].size,
...
function calcY(y) {
  var temp = y / 100 * vh + vh * sectionActive;
  return temp + "px";
}
...
function heroMouseAnimation(e) {
  var buffer = 20; // how far compared to screen size to travel
  var delay = 0.1; // delay of smoothnes

  //Reposition title
  var titleX = mouseX / buffer;
  var titleY = (centerY - mouseY) / buffer;
  _TweenMax.TweenMax.to(heroTitle, delay, { x: titleX, y: titleY });

  //Reposition hero image
  var imgX = (centerX - mouseX) / buffer;
  var imgY = mouseY / buffer;
  _TweenMax.TweenMax.to(heroImg, delay, { x: imgX, y: imgY });
}
...
function introHeadlineWhiteBarPosition() {
  ...
  var fontSize = parseFloat(window.getComputedStyle(introHeadlineDOM, null).getPropertyValue("font-size"));
  var paddingTop = window.getComputedStyle(introHeadlineDOM, null).getPropertyValue("padding-top");
...
function introHeadlineWhiteBarAnimation() {
  //Set width
  var moveTo = introWrapper.offsetLeft + introHeadline.width + 100;

  var tl = new _TweenMax.TimelineMax();
  var duration = 1;

  tl.to(introWhiteBar, duration, { width: moveTo + "px" }).to(introHeadlineDOM, 0.1, { opacity: 1 }).to(introWhiteBar, duration, {
    width: "0vw"
  });
}
...
function techCirclesCoordinates() {
  ...
  var techLine = techLineDOM.getBoundingClientRect();
  var posY = techLine.top + window.scrollY - 10 + "px";
  var startX = techLine.left + "px";
  techStartX = startX;
  var stopX = techLine.right + "px";
  var distance = techLine.right - techLine.left - 10;
...
function techCirclesAnimation() {
  ...
  techCirclesTL.fromTo(circles[0], duration, { x: 0 }, { x: techDistance }).fromTo(circles[1], duration, { x: 0, delay: duration }, { x: techDistance, ease: _TweenMax.Power0.easeNone }).fromTo(circles[2], duration, { x: 0, delay: duration }, { x: techDistance, ease: _TweenMax.Power0.easeNone }).fromTo(circles[3], duration, { x: 0, delay: duration }, {
    x: techDistance,
...
function techCodeEditorSetup() {
  techEditorCodeTL = new _TweenMax.TimelineMax({ repeat: -1, repeatDelay: 1 });
  techEditorLines.forEach(function (line) {
    var temp = line.getAttribute("width") + "px";
...
function techCodeEditorAnimation() {
  var duration = 0.7;
  var easeProcess = _TweenMax.SteppedEase.config(5);

  techEditorCodeTL.fromTo(techEditorLines[10], duration, { width: 0 }, {
    width: techEditorLinesWidth[10],
    ease: easeProcess
  }).fromTo(techEditorLines[9], duration, { width: 0 }, {
    width: techEditorLinesWidth[9],
    ease: easeProcess
  }).fromTo(techEditorLines[8], duration, { width: 0 }, {
    width: techEditorLinesWidth[8],
    ease: easeProcess
  }).fromTo(techEditorLines[7], duration, { width: 0 }, {
    width: techEditorLinesWidth[7],
    ease: easeProcess
  }).fromTo(techEditorLines[6], duration, { width: 0 }, {
    width: techEditorLinesWidth[6],
    ease: easeProcess
  }).fromTo(techEditorLines[5], duration, { width: 0 }, {
    width: techEditorLinesWidth[5],
    ease: easeProcess
  }).fromTo(techEditorLines[4], duration, { width: 0 }, {
    width: techEditorLinesWidth[4],
    ease: easeProcess
  }).fromTo(techEditorLines[3], duration, { width: 0 }, {
    width: techEditorLinesWidth[3],
    ease: easeProcess
  }).fromTo(techEditorLines[2], duration, { width: 0 }, {
    width: techEditorLinesWidth[2],
    ease: easeProcess
  }).fromTo(techEditorLines[1], duration, { width: 0 }, {
    width: techEditorLinesWidth[1],
    ease: easeProcess
  }).fromTo(techEditorLines[0], duration, { width: 0 }, {
...
function techDisplayData() {
  techSliderData.forEach(function (item) {
    var clone = techTemplate.cloneNode(true);
    clone.querySelector("img").setAttribute("src", "assets/icons/technologies/" + item.img);
...
function techSliderAnimation() {
  ...
  var moveTo = -techContainerWidth / 2 - techSliderItem.getBoundingClientRect().width;
  if (!techSliderActivated) {
    //apply animation
    var tm = new _TweenMax.TweenMax.fromTo(techContainer, duration, { left: 0, ease: _TweenMax.Power0.easeNone }, {
      left: moveTo + "px",
      ease: _TweenMax.Power0.easeNone,
      repeat: -1,
      repeatDelay: 0
...
function portDataSetup() {
  portData = [{
    ...
    img: "amelie-niel.png",
    desc: "Amélie Niel is a french artist who loves handcrafted art. Her existing website has been redesigned and on request, a webshop has been implemented. ",
    linkDesc1: "PROTOTYPE",
    ...
    img: "yfu.png",
    desc: "YFU were in need of a marketing campaign to promote their service and strengthen their brand identity. This protoype website is supported by a SoMe video and a survey.",
    linkDesc1: "prototype",
    ...
    img: "afdahm.png",
    desc: "afDahm is a portfolio website of a danish/swedish clothes designer and maker, which also features a blog.",
    linkDesc1: "Website",
    ...
    desc: "This is a futuristic dashboard idea for a bar manager who can easily keep track of everything by the help of sensors and motion tracker.",
    linkDesc1: "Prototype",
    ...
    desc: "CSS Unit Game is a website i created in my spare time. The target group is everybody who's working in the digital world (marketing, design...) to give them the ability to play around, without using developer tools.",
    linkDesc1: "Website",
    ...
    img: "advena.png",
    desc: "Advena.me is my homepage, where I distribute selfmade free digital tools, store my courses and share mediums and knowledge. This portfolio website aims at displaying my skills. ",
    linkDesc1: "Website",
    linkURL1: "https://repo.advena.me/css-game/",
    linkDesc2: "",
    linkURL2: ""
...
function portDisplayWork() {
  portData.forEach(function (work) {
    var clone = portTemplate.cloneNode(true);

    clone.querySelector(".title h2").textContent = work.title;
    clone.querySelector(".title p").textContent = work.underTitle;
    clone.querySelector(".image img").setAttribute("src", "assets/img/portfolio/" + work.img);
    clone.querySelector(".description p").textContent = work.desc;

    if (!work.linkURL1 == "") {
      clone.querySelector(".call-to-action a:nth-of-type(1)").innerHTML = work.linkDesc1 + " <img src='assets/icons/new-tab-icon.svg'>";
      clone.querySelector(".call-to-action a:nth-of-type(1)").setAttribute("href", work.linkURL1);
    } else {
      clone.querySelector(".call-to-action a:nth-of-type(1)").style.display = "none";
    }

    if (!work.linkURL2 == "") {
      clone.querySelector(".call-to-action a:nth-of-type(2)").innerHTML = work.linkDesc2 + " <img src='assets/icons/new-tab-icon.svg'>";
      clone.querySelector(".call-to-action a:nth-of-type(2)").setAttribute("href", work.linkURL2);
    } else {
      clone.querySelector(".call-to-action a:nth-of-type(2)").style.display = "none";
    }
...
function portSliderSetup() {
  ...
  portWorkMarginRight = parseFloat(window.getComputedStyle(portWork, null).getPropertyValue("margin-right")); //get work element margin right
...
function portSliderSlideRight() {
  portContainerLeft = portContainer.offsetLeft;
  var portLimitRight = portMoveDistance - portContainerWidth;
  var moveTo = portContainerLeft - portMoveDistance;
  ...
  if (portCurrentPage < portData.length && !portSliderAnimationActive) {
    ...
    _TweenMax.TweenMax.to(portContainer, 0.7, {
      left: moveTo,
      onStart: function onStart() {
...
function contactAnimateWhiteSplitter(status) {
  if (status) {
    _TweenMax.TweenLite.to(contactWhiteSplitter, 0.7, {
...
},{"gsap/TweenMax":"node_modules\\gsap\\TweenMax.js","gsap/ScrollToPlugin":"node_modules\\gsap\\ScrollToPlugin.js","hammerjs":"node_modules\\hammerjs\\hammer.js","is_js":"node_modules\\is_js\\is.js","validator-js":"node_modules\\validator-js\\src\\validator.js","../styles/sass/main.scss":"styles\\sass\\main.scss"}],"..\\..\\..\\AppData\\Roaming\\npm\\node_modules\\parcel-bundler\\src\\builtins\\hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/script.858d9316.map